      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        {mode === 'register' && (
          <Field label="Confirmar contraseña">
            <FieldIcon><Lock size={15} color="#5C5A55" /></FieldIcon>
            <input style={{ ...INPUT, paddingRight: 40, borderColor: confirm && password !== confirm ? '#B83232' : '#E4E2DC' }} type={showConfirm ? 'text' : 'password'} value={confirm} onChange={e => setConfirm(e.target.value)} placeholder="Repite tu contraseña" onKeyDown={e => e.key === 'Enter' && handleSubmit()} />
