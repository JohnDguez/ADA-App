...
export function nextBiweeklyDate() {
  const t = today()
  const d = t.getDate()
  if (d < 16) { const r = new Date(t); r.setDate(16); return r }
...
// Valida si un nombre ya existe entre los pagos del usuario
export function nameExists(payments, name, excludeId = null) {
