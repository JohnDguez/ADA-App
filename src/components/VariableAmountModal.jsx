...
export function VariableAmountModal({ open, payment, mode = 'pay', onConfirm, onClose }) {
    ...
    <>
      <div onClick={e => e.target === e.currentTarget && requestClose()} style={{
        ...
        <div style={{
          ...
          <button onClick={handleConfirm} className="btn-primary" style={{ marginBottom: 8 }}>{mode === 'estimate' ? 'Guardar monto' : 'Confirmar pago'}</button>
